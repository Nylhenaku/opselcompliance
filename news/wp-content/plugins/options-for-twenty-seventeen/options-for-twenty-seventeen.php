...
?>
.colors-dark .site-content-contain, .colors-dark .navigation-top, .colors-dark .main-navigation ul, .colors-custom .navigation-top, .colors-custom .main-navigation ul, .site-content-contain, .navigation-top {
...
background: linear-gradient(to bottom, rgba(<?= $r; ?>, <?= $g; ?>, <?= $b; ?>, 0) 0%, rgba(<?= $r; ?>, <?= $g; ?>, <?= $b; ?>, <?= $gradient_opacity; ?>) 75%, rgba(<?= $r; ?>, <?= $g; ?>, <?= $b; ?>, <?= $gradient_opacity; ?>) 100%);
}
<?php
...
@media screen and (min-width: 48em) {
    .site-navigation-fixed.navigation-top {
        width: <?= get_theme_mod('nav_bar_width'); ?>;
        left: 50%;
...
@media screen and (min-width: 48em) {
	.main-navigation a {
		padding-top: <?= $mod - 1; ?>px;
		padding-bottom: <?= $mod - 1; ?>px;
	}
}
<?php
            ...
            oftsCommon::generate_css('.navigation-top a, .colors-dark .navigation-top a', 'color', 'nav_link_color', '', '');
            oftsCommon::generate_css('.dropdown-toggle, .menu-toggle, .colors-dark .menu-toggle', 'color', 'nav_link_color', '', '');
            oftsCommon::generate_css('.navigation-top .current-menu-item > a, .navigation-top .current_page_item > a, .colors-dark .navigation-top .current-menu-item > a, .colors-dark .navigation-top .current_page_item > a', 'color', 'nav_current_link_color', '', '');
...
?>
.navigation-top {
	background-color: rgba(255, 255, 255, <?= $background_opacity; ?>);
	border-top-color: rgba(238, 238, 238, <?= $background_opacity; ?>);
	border-bottom-color: rgba(238, 238, 238, <?= $background_opacity; ?>);
}
.colors-dark .navigation-top {
	background-color: rgba(34, 34, 34, <?= $background_opacity; ?>);
	border-top-color: rgba(51, 51, 51, <?= $background_opacity; ?>);
	border-bottom-color: rgba(51, 51, 51, <?= $background_opacity; ?>);
}
<?php
...
.colors-custom .navigation-top {
	background-color: background: hsla(' . $hue . ', ' . $saturation . ', 100%, <?= $background_opacity; ?>);
	border-top-color: hsla(' . $hue . ', ' . $saturation . ', 93%, <?= $background_opacity; ?>);
	border-bottom-color: hsla(' . $hue . ', ' . $saturation . ', 93%, <?= $background_opacity; ?>);
}
<?php
...
.site-content, .panel-content .wrap {
    padding-top: <?= number_format(((($mod / 2) - 0.5) / 5.5 * 2.5), 3); ?>em;
}
@media screen and (min-width: 48em) {
    .site-content, .panel-content .wrap {
...
<?php
            ...
            oftsCommon::generate_css('body.page .entry-header .entry-title, .colors-dark .page .panel-content .entry-title, .colors-dark.page:not(.twentyseventeen-front-page) .entry-title', 'color', 'page_entry_header_title_color');
...
<a href="<?= add_query_arg('search', 'twentyseventeen', admin_url('theme-install.php')); ?>" title="<?= __('Twenty Seventeen', 'options-for-twenty-seventeen'); ?>"><?php
