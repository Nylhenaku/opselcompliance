...
class StreamWrapper
{
    ...
    {
        // Stat "../../../../../../../../../news/wp-content/plugins/updraftplus/vendor/aws/aws-sdk-php/src/S3/directories": buckets, or "s3://"
        if (!$parts['Bucket'] ||
    ...
    public function dir_readdir()
    {
        ...
        if (isset($cur['Prefix'])) {
            // Include "../../../../../../../../../news/wp-content/plugins/updraftplus/vendor/aws/aws-sdk-php/src/S3/directories". Be sure to strip a trailing "/"
            // on prefixes.
