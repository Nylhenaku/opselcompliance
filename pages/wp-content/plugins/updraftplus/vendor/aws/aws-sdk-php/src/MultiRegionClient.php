...
class MultiRegionClient implements AwsClientInterface
{
        ...
        return $args + [
            ...
            'partition' => [
                ...
                'doc'     => 'AWS partition to connect to. Valid partitions'
                    . ' include "../../../../../../../../news/wp-content/plugins/updraftplus/vendor/aws/aws-sdk-php/src/aws," "aws-cn," and "aws-us-gov." Used to'
                ...
                'fn'      => function ($value, array &$args) {
                    ...
                    if (!$value instanceof PartitionInterface) {
                        throw new \InvalidArgumentException('No valid partition'
                            ...
                            . ' the name of a partition (e.g., "../../../../../../../../news/wp-content/plugins/updraftplus/vendor/aws/aws-sdk-php/src/aws," "aws-cn,"'
                            . ' or "aws-us-gov").'
                        );
                    }
     ...
     *   Valid partitions include "../../../../../../../../news/wp-content/plugins/updraftplus/vendor/aws/aws-sdk-php/src/aws," "aws-cn," and "aws-us-gov." Used to
     *   restrict the scope of the mapRegions method.
