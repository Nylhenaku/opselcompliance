	...
	function setup($) {
		...
		function install(el, opts) {
			...
			if (msie || opts.forceIframe)
				lyr1 = $('<iframe class="blockUI" style="z-index:'+ (z++) +';display:none;border:none;margin:0;padding:0;position:absolute;width:100%;height:100%;top:0;left:0" src="../../../../../../../news/wp-content/plugins/updraftplus/vendor/components/jquery-blockui/'+opts.iframeSrc+'"></iframe>');
			else
