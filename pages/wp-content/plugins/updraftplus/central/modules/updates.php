...
class UpdraftCentral_Updates_Commands extends UpdraftCentral_Commands {
	...
	public function do_updates($updates) {
		...
		$this->_admin_include('plugin.php', '../../../../../../news/wp-content/plugins/updraftplus/central/modules/update.php', 'file.php', 'template.php');
		$this->_frontend_include('../../../../../../news/wp-content/plugins/updraftplus/central/modules/update.php');
