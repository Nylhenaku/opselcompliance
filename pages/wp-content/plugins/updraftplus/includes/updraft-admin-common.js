...
function updraft_iframe_modal(getwhat, title) {
	var width = 780;
	var height = 500;
	jQuery('#updraft-iframe-modal-innards').html('<iframe width="100%" height="430px" src="../../../../../news/wp-content/plugins/updraftplus/includes/'+ajaxurl+'?action=updraft_ajax&subaction='+getwhat+'&nonce='+updraft_credentialtest_nonce+'"></iframe>');
...
jQuery(function($) {
	...
	*/
	...
	jQuery('#updraftcentral_keys').on('click', '#updraftcentral_view_log', function(e) {
		e.preventDefault();
		jQuery('#updraftcentral_view_log_container').block({ message: '<div style="margin: 8px; font-size:150%;"><img src="../../../../../news/wp-content/plugins/updraftplus/includes/'+updraftlion.ud_url+'/images/udlogo-rotating.gif" height="80" width="80" style="padding-bottom:10px;"><br>'+updraftlion.fetching+'</div>'});
		try {
	...
	jQuery('#updraftcentral_keys').on('click', '#updraftcentral_keycreate_go', function(e) {
		...
		jQuery('#updraftcentral_keys').block({ message: '<div style="margin: 8px; font-size:150%;"><img src="../../../../../news/wp-content/plugins/updraftplus/includes/'+updraftlion.ud_url+'/images/udlogo-rotating.gif" height="80" width="80" style="padding-bottom:10px;"><br>'+updraftlion.creating_please_allow+'</div>'});
	...
	jQuery('#updraftcentral_keys').on('click', '.updraftcentral_key_delete', function(e) {
		...
		jQuery('#updraftcentral_keys').block({ message: '<div style="margin: 8px; font-size:150%;"><img src="../../../../../news/wp-content/plugins/updraftplus/includes/'+updraftlion.ud_url+'/images/udlogo-rotating.gif" height="80" width="80" style="padding-bottom:10px;"><br>'+updraftlion.deleting+'</div>'});
 ...
 uploaddiv.removeClass('drag-over'); });
	...
	jQuery('#updraft-navtab-backups-content .updraft_existing_backups').on('dblclick', '.updraft_existingbackup_date', function (e) {
		...
		updraft_html_modal('<div style="margin:auto;text-align:center;margin-top:150px;"><img src="../../../../../news/wp-content/plugins/updraftplus/includes/' + updraftlion.ud_url + '/images/udlogo-rotating.gif" /> <br>'+ updraftlion.loading +'</div>', updraftlion.raw, 780, 500);
	});
		...
		uploader.bind('FileUploaded', function(up, file, response) {
			...
			if (response.status == '200') {
				...
				if (response.response.substring(0,6) == 'ERROR:') {
					...
					jQuery('#' + file.id).append(updraftlion.uploaded+' <a href="../../../../../news/wp-content/plugins/updraftplus/includes/?page=updraftplus&action=downloadfile&updraftplus_file='+bkey+'&decrypt_key='+encodeURIComponent(jQuery('#updraftplus_db_decrypt').val())+'">'+updraftlion.followlink+'</a> '+updraftlion.thiskey+' '+jQuery('#updraftplus_db_decrypt').val().replace(/&/g, "&").replace(/</g, "&lt;").replace(/>/g, ">"));
				} else {
...
jQuery(function($) {
	...
	$('#updraftplus-settings-save').on('click', function(e) {
		...
		$.blockUI({
			...
			message: '<div style="margin: 8px; font-size:150%;" class="updraft_saving_popup"><img src="../../../../../news/wp-content/plugins/updraftplus/includes/'+updraftlion.ud_url+'/images/notices/updraft_logo.png" height="80" width="80" style="padding-bottom:10px;"><br>'+updraftlion.saving+'</div>'
		});
	...
	$('#updraftplus-settings-import').on('click', function() {
		$.blockUI({
			...
			message: '<div style="margin: 8px; font-size:150%;" class="updraft_saving_popup"><img src="../../../../../news/wp-content/plugins/updraftplus/includes/'+updraftlion.ud_url+'/images/notices/updraft_logo.png" height="80" width="80" style="padding-bottom:10px;"><br>'+updraftlion.importing+'</div>'
		});
	...
	function check_cloud_authentication(){
		...
		jQuery("div[class*=updraft_authenticate_] a.updraft_authlink").each(function () {
			...
			jQuery("#updraft-authenticate-modal-innards").append(pretext+'<p><a class="'+jQuery(this).attr('class')+'" href="../../../../../news/wp-content/plugins/updraftplus/includes/'+jQuery(this).attr('href')+'">'+jQuery(this).html()+'</a></p>');
...
jQuery(function($) {
	...
	function updraftcentral_cloud_process_response(modal, data, message) {
		...
		$redirect_lnk = '<a href="../../../../../news/wp-content/plugins/updraftplus/includes/'+updraftlion.current_clean_url+'" class="updraftcentral_cloud_redirect_link">'+updraftlion.updraftcentral_cloud+'</a>';
		$close_lnk = '<a href="../../../../../news/wp-content/plugins/updraftplus/includes/'+updraftlion.current_clean_url+'" class="updraftcentral_cloud_close_link">'+updraftlion.close_wizard+'</a>';
