	...
	private function ensure_crypto_loaded() {
		if (!class_exists('Crypt_Rijndael') || !class_exists('Crypt_RSA') || !class_exists('Crypt_Hash')) {
			...
			if (is_a($updraftplus, 'UpdraftPlus')) {
				...
				if (!class_exists('Crypt_Rijndael')) include_once '../../../../../news/wp-content/plugins/updraftplus/includes/Crypt/Rijndael.php';
				if (!class_exists('Crypt_RSA')) include_once '../../../../../news/wp-content/plugins/updraftplus/includes/Crypt/RSA.php';
				if (!class_exists('Crypt_Hash')) include_once '../../../../../news/wp-content/plugins/updraftplus/includes/Crypt/Hash.php';
